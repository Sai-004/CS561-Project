...
class Robot:
    ...
    def _get_rgbd_image(self):
        ...
        rgb_array = np.reshape(img_arr[2], (self.camera_height, self.camera_width, 4))[:, :, :3]
    ...
    def _detect_cylinders(self, image):
        ...
        # Create a mask to exclude black regions (low value in HSV)
        # Black is defined as having a low V (value/brightness) in HSV
        ...
        # Apply the not-black mask to exclude black regions
